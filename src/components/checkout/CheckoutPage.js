                                        ...
                                        <div className="single-order-content">
                                            <div className="product-order-details">
                                                <div className="product-detais-order-innder">
                                                    <div className="prduct-order-count">	<span>1.</span>
                                                    </div>
                                                    <div className="product-order-name">
                                                        <ul>
                                                            <li>3 Regular Ticket</li>
                                                            <li>2 Adult + 1 Child</li>
                                                            <li>Fantasy Kingdom+ No Food</li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="product-total-order-price">	<span>1300 BDT</span>
                                            </div>
                                        </div>
                                        <div className="single-order-content">
                                            <div className="product-order-details">
                                                <div className="product-detais-order-innder">
                                                    <div className="prduct-order-count">	<span>2.</span>
                                                    </div>
                                                    <div className="product-order-name">
                                                        <ul>
                                                            <li>1 Free Deals</li>
                                                            <li>2 Adult</li>
                                                            <li>Fantasy Kingdom, Water Kingdom</li>
                                                            <li>+ Free Lunch</li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="product-total-order-price">	<span>1000 BDT</span>
                                            </div>
                                        </div>
                                        <div className="charge-order-content">	<span>Charge</span>
                                            <span>0 BDT</span>
                                        </div>
