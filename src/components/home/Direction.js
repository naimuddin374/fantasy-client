                        ...
                        <div className="col-lg-8 col-md-8 offset-lg-2 offset-md-2">
                            <div className="row">
                                ...
                                <div className="col-lg-3 col-md-6 direact-content-col">
                                    <div className="direction-content">
                                        <Link to="/">
                                            <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 99 99">
                                                <g id="Group_1304" transform="translate(-1248 -2216)">
                                                    <circle id="Ellipse_19" className="st0" cx="1297.5" cy="2265.5" r="49.5" />
                                                    <g id="Group_1210" transform="translate(-8549 412.164)">
                                                        <g id="Ellipse_15" transform="translate(9820 1826.836)">
                                                            <circle className="st1" cx="26" cy="26" r="26" />
                                                            <circle className="st2" cx="26" cy="26" r="24" />
                                                        </g>
                                                        <path id="Union_1" className="st3" d="M9845.8,1855.5L9845.8,1855.5z" />
                                                    </g>
                                                </g>
                                                <polyline className="st4" points="64.8,51.7 48.8,51.7 48.8,35.7 " />
                                            </svg>
