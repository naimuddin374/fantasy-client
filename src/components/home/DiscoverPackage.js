...
class DiscoverPackage extends React.Component {
    render() {
		...
		<div className="container">
			...
			<div className="row">
				<div className="discover-carousel-wrapper owl-carousel">
					<div className="single-discover-carousel">
						<Link to="/"><img src="./assets/images/resorts/resort1.png" alt="resorts" /></Link>
						<div className="resport-open-close">
							<span className="offer-shape">Closed today</span>
						</div>
						<div className="resort-heading-content">
							<Link to="/"><h3>Heritage Park</h3></Link>
							<h5>N302, Baipayl</h5>
							<h6>Closes at  8: 00 PM</h6>
						</div>
					...
					<div className="single-discover-carousel">
						<Link to="/"><img src="./assets/images/resorts/resport2.png" alt="resorts"/></Link>
						<div className="resport-open-close">
							<span className="offer-shape">Open today</span>
						</div>
						<div className="resort-heading-content">
							<Link to="/"><h3>Xtreme racing</h3></Link>
							<h5>N302, Baipayl</h5>
							<h6>Closes at  8: 00 PM</h6>
						</div>
						<div className="resorts-linked-btn">
					...
					<div className="single-discover-carousel">
						<Link to="/"><img src="./assets/images/resorts/resort3.png" alt="resorts"/></Link>
						<div className="resport-open-close">
							<span className="offer-shape">Open today</span>
						</div>
						<div className="resort-heading-content">
							<Link to="/"><h3>Resort Atlantis</h3></Link>
							<h5>N302, Baipayl</h5>
							<h6>Closes at  8: 00 PM</h6>
						</div>
						<div className="resorts-linked-btn">
