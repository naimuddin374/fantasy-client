...
class ShortLinkMobile extends Component {
    render() {
        let settings = {
            loop: true,
            fade: false,
        ...
        return (
            <Fragment>
                <section className="linked-area absoluteshape-header" id="icon-wrapper-mobile">
                    <div className="container">
                        <div className="linked-wrapper slider-bottom-linked" id="mobile-shortlinked-icon">
                            <Slider {...settings}>
...
export default ShortLinkMobile
