                        ...
                        <div className="row">
                            ...
                            <div className="col-lg-6 col-md-6">
                                ...
                                <div className="direction-area-fantasy-kingdom">
                                    ...
                                    <div className="single-direction-map">
                                        <Link to={`${process.env.PUBLIC_URL}/`}>	<i className="fa fa-clock-o" aria-hidden="true"></i>
