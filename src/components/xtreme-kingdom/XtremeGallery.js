...
class XtremeGallery extends React.Component {
    render() {
        let settings = {
            dots: true,
            infinite: false,
                    ...
                    <svg id="Group_1471" data-name="Group 1471" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1920 780">
                        <defs>
                            <clipPath id="clip-path">
                                <rect id="Rectangle_378" data-name="Rectangle 378" width="1920" height="780" fill="none"></rect>
                            </clipPath>
                        </defs>
                ...
                <div className="container">
                    <div className="row">
                        <div className="col-md-12">
                            <div className="section-title-small-text xtreme-section-title-small-text mb-40">
                                <h2>Gallery</h2>
                            </div>
                        </div>
                    </div>
                    <div className="fantasy-gallery-slider2">
                        <Slider {...settings}>
                            <div className="col-md-12">
                                <Link className="project-gallery popup" href="assets/images/gallery/gallery1.png">
                                    <img src="./assets/images/gallery/gallery1.png" alt="gallery" />
                                </Link>
                            </div>
                            <div className="col-md-12">
                                <Link className="project-gallery popup" href="assets/images/gallery/gallery2.png">
                                    <img src="./assets/images/gallery/gallery2.png" alt="gallery" />
                                </Link>
                            </div>
                            <div className="col-md-12">
                                <Link className="project-gallery popup" href="assets/images/gallery/gallery3.png">
                                    <img src="./assets/images/gallery/gallery3.png" alt="gallery" />
                                </Link>
                            </div>
                            <div className="col-md-12">
                                <Link className="project-gallery popup" href="assets/images/gallery/gallery4.png">
                                    <img src="./assets/images/gallery/gallery4.png" alt="gallery" />
                                </Link>
                            </div>
                            <div className="col-md-12">
                                <Link className="project-gallery popup" href="assets/images/gallery/gallery5.png">
                                    <img src="./assets/images/gallery/gallery5.png" alt="gallery" />
                                </Link>
                            </div>
                            <div className="col-md-12">
                                <Link className="project-gallery popup" href="assets/images/gallery/gallery6.png">
