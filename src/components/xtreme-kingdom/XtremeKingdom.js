...
import XtremeMap from './XtremeMap'
import XtremeThings from './XtremeThings'
import XtremeDiscount from './XtremeDiscount'
import XtremeGallery from './XtremeGallery'
import XtremeShopping from './XtremeShopping'
import XtremeFaq from './XtremeFaq';
import { Link } from 'react-router-dom'

class XtremeKingdom extends React.Component {
    componentDidMount() {
        window.scrollTo(0, 0)
    }
    render() {
        return (
            <div>
                ...
                <section className="breadcrum-area xtreme-feature-img relative">
                    ...
                    <div className="container">
                        <div className="row">
                            <div className="col-lg-12 col-md-12">
                                <div className="section-title xtreme-section-title mb-40">
                                    <h2>Experience VR</h2>
                                </div>
                            </div>
                        </div>
