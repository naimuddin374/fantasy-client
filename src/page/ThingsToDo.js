                            ...
                            <div className="row">
                                <div className="col-lg-4 col-md-6">
                                    <div className="single-thing-to-do-content single-advanture-ride popular-item-border">
                                        <Link to="/">
                                            <img src="./assets/images/thingtodo/1.png" alt="advanture img" />
                                        </Link>
                                        ...
                                        <div className="thing-to-do-inner-content">
                                            <div className="t-top-content">
                                                ...
                                                <div className="aggressive-hight-content"> <span className="aggressive t-agg-high">Aggressive Thrill</span>
                                                </div>
                                            </div>
                                ...
                                <div className="col-lg-4 col-md-6">
                                    <div className="single-thing-to-do-content single-advanture-ride popular-item-border">
                                        <Link to="/">
                                            <img src="./assets/images/thingtodo/2.png" alt="advanture img" />
                                        </Link>
                                        <div className="popular-item"> <span className="thing-popular">popular</span>
                                        </div>
                                        <div className="thing-to-do-inner-content">
                                            <div className="t-top-content">
                                                <div className="t-title-content"> <Link to="/" className="t-tile">Santa Maria</Link>
                                                </div>
                                                <div className="aggressive-hight-content"> <span className="hightrill t-agg-high">High Thrill</span>
                                                </div>
                                            </div>
                                ...
                                <div className="col-lg-4 col-md-6">
                                    <div className="single-thing-to-do-content single-advanture-ride popular-item-border">
                                        ...
                                        <div className="thing-to-do-inner-content">
                                            <div className="t-top-content">
                                                <div className="t-title-content"> <Link to="/" className="t-tile">Magic Carpet</Link>
                                                </div>
                                                <div className="aggressive-hight-content"> <span className="hightrill t-agg-high">High Thrill</span>
                                                </div>
                                            </div>
                                    ...
                                    <div className="single-thing-to-do-content single-advanture-ride">
                                        ...
                                        <div className="thing-to-do-inner-content">
                                            <div className="t-top-content">
                                                ...
                                                <div className="aggressive-hight-content"> <span className="midtrill t-agg-high">Mid Thrill</span>
                                                </div>
                                            </div>
                                            <p>For the lovers of heart-thumping adventures, the roller coaster will take you on the ride of your life giving you an aerial view of the entire park.</p>
                                            <div className="t-bottom-content">
