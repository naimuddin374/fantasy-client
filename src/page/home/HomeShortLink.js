...
class HomeShortLink extends React.Component {
    render() {
        return (
            <section className="linked-area absoluteshape-header">
                <div className="container">
                    <div className="row linked-wrapper slider-bottom-linked">
