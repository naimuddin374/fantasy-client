...
class XtremeFaq extends React.Component {
    componentDidMount() {
        window.scrollTo(0, 0)
    }
    render() {
                ...
                <div className="container">
                    <div className="row">
                        <div className="col-lg-8 offset-lg-2 col-md-8 offset-md-2">
                            <div className="section-title-small-text xtreme-section-title-small-text text-center mb-4">
                                <h2>FAQ</h2>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div className="faq-main for-rent mgtop50">
                                        <div className="accordion mgtop16 faq-area" data-wow-delay=".2s" id="accordionExample">
                                            <div className="card faq-inner-content">
                                                <div className="card-header faq-heading" id="headingOne"> <Link data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                                    How to contact us
                                        </Link>
                                                </div>
                                            ...
                                            <div className="card faq-inner-content">
                                                <div className="card-header faq-heading" id="headingThree"> <Link className="collapsed" data-toggle="collapse" data-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                                            ...
                                            <div className="card faq-inner-content">
                                                <div className="card-header faq-heading" id="headingFour"> <Link className="collapsed" data-toggle="collapse" data-target="#collapseFour" aria-expanded="false" aria-controls="collapseFour">
