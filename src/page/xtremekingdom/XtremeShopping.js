...
class XtremeShopping extends React.Component {
    render() {
        return (
                    ...
                    <div className="row">
                        <div className="col-lg-6 col-md-6">
                            <div className="dining-table-content fantasy-hotel-table-content">
                                <div className="fantasy-hotel-table-title section-title-small-text xtreme-section-title-small-text">
                                    <h2>Dining</h2>
                                </div>
